...
export default function Rentals() {
  const maxPrice = 80000; // For calculating bar width
    ...
    <section id="rentals" className="py-24 px-4 bg-white relative">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {rentalOptions.map((option, index) => (
            <motion.div
              key={index}
              whileHover={{ y: -5 }}
              className="bg-[#FFF9F2] rounded-2xl p-6 border border-neutral-100 shadow-sm flex flex-col"
            >
        ...
        <motion.div 
          ...
          className="bg-neutral-900 rounded-2xl p-8 text-white flex flex-col md:flex-row items-center justify-between gap-6 max-w-4xl mx-auto shadow-2xl"
        >
